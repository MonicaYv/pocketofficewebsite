...
<div class="email-wrapper">
  ...
  <div class="header">
    <div class="logo">
      <div class="logo-icon">
        ...
        <img src="{{ url($constants['IMAGEFILEPATH'] . 'office.png') }}" alt="office-logo" />
      </div>
    </div>
    <div class="social-icons">
      ...
      <a href="#" aria-label="Twitter">
        ...
        <img src="{{ url($constants['IMAGEFILEPATH'] . 'twitter-2.png') }}" alt="twitter-logo" />
      </a>
      <!-- Facebook -->
      <a href="#" aria-label="Facebook">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg>
        <img src="{{ url($constants['IMAGEFILEPATH'] . 'facebook-2.png') }}" alt="facebook-logo" />
      </a>
      <!-- Instagram -->
      <a href="#" aria-label="Instagram">
        ...
        <img src="{{ url($constants['IMAGEFILEPATH'] . 'instagram-2.png') }}" alt="instagram-logo" />
      </a>
      <a href="#" aria-label="linkdlen">
        <!-- <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg> -->
        <img src="{{ url($constants['IMAGEFILEPATH'] . 'linkdlen-2.png') }}" alt="linkdlen-logo" />
      </a>
    </div>
  </div>
  ...
  <div class="hero">
    ...
    <img class="hero-illustration" src="{{ url($constants['IMAGEFILEPATH'] . 'hero-bg.png') }}" alt="Hero Image">
  ...
  <div class="body">
    ...
    <div class="credentials">
      ...
      <div class="credential-row">
        ...
        <button class="copy-btn btn-mail" title="Copy username">
  ...
  <div class="footer">
    ...
    <div class="footer-socials">
      ...
      <a href="#" aria-label="Facebook">
        ...
        <img src="{{ url($constants['IMAGEFILEPATH'] . 'facebook-2.png') }}" alt="office-logo" />
      </a>
      <!-- Twitter -->
      <a href="#" aria-label="Twitter">
        ...
        <img src="{{ url($constants['IMAGEFILEPATH'] . 'twitter-2.png') }}" alt="office-logo" />
      </a>
      <!-- LinkedIn -->
      <a href="#" aria-label="LinkedIn">
        ...
        <img src="{{ url($constants['IMAGEFILEPATH'] . 'linkdlen-2.png') }}" alt="office-logo" />
      </a>
      <!-- Instagram -->
      <a href="#" aria-label="Instagram">
        ...
        <img src="{{ url($constants['IMAGEFILEPATH'] . 'instagram-2.png') }}" alt="office-logo" />
      </a>
    </div>
  </div>
