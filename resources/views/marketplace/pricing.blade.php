                 ...
                 <div class="po-price-block">
                  ...
                  <div class="po-summary feature-list">
                    ...
                    <div class="total-amt-sty">
                      ...
                      <hr>
                      <div class="po-save-line d-flex align-items-center justify-content-between">
                        <div><i class="fa-solid fa-tag"></i> You Save</div> 
                        <div><span class="view-currency"></span><span class="total-savings view-total-savings-count">0</span></div>
                      </div>
                    </div>
                  </div>
 <!-- discount  -->
