                  ...
                  <div class="col-xl-6 d-flex">
                      ...
                      <div class="pricing-title-row">
                              <div class="currency-dropdown-wrapper">
                                  @php
                                      $selectedCurrencyData = $currencies->firstWhere(
                                          'currency_code',
                                          $selectedCurrency,
                                      );
                                  @endphp
                  ...
                  <div class="teams-section-wrapper">
                      ...
                      <div class="pricing-cards">
                                  ...
                                  <div class="monthly-plans" data-is-team="1">
                                      <div class="card bg-light border-secondary h-100 ul-cards">
                                          <div class="card-body d-flex flex-column p-4">
                                              <div>
                                                  <h2 class="fw-semibold" data-plan-name="{{ $plan->plans_name }}">
                                                      {{ $plan->plans_name }}</h2>
                                              ...
                                              <div class="original-price-wrapper">
                                                  <div class="flex original-price original-price-team">
                                                      <span class="personal-card-symbol-ul-team"></span> &nbsp; <span
                                                          class="ul-original-price-team"></span>
                                              ...
                                              <span class="price-amount hidden" data-monthly="{{ $plan->plans_amount }}"
                                                  ...
                                                  <li class="mb-3 d-flex align-items-start">
                                                      <div class="quantity-box ul-quantity-container">
                                                          ...
                                                          <input type="text" class="qty-input ul-quantity-input"
                                                              ...
                                                              data-default-qty="{{ $plan->default_qty }}" readonly />
                          ...
                          <span class="view-storage-unit">{{ $plan->storage_unit }}</span>
                                                  ...
                                                  <li discount-apply="{{ $plan->is_team_discount_apply }}"
                                                      class="mb-3 d-flex align-items-start justify-content-between"
                                                      style="color: #065f46; font-weight: 600; display: none;">
                                                      <span>Discount :&nbsp;</span>
                                                      <div>
                                                  ...
                                                  <li class="mb-3 total-amt-sty">
                                                      ...
                                                      <hr style="width: 100%;  border: 1px dashed #ccc; margin: 10px 0;">
                                                      <p><i class="fa-solid fa-tag"></i> You save <span
                                                              class="total-savings view-total-savings-count">$</span></p>
                                                  </li>
                                                  <!-- discount  -->
                                                  ...
                                                  @php
                                                      ...
                                                      $currentFeatures =
                                                          $planFeatures[$plan->plans_name] ?? $planFeatures['Basic'];
                                                  @endphp
