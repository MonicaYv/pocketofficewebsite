  ...
  @section('meta-title', 'Privacy Policy | Pocket Office Cloud Desktop')
  @section('meta-description', 'Review the Pocket Office privacy policy for data protection, personal information handling, and privacy rights in our cloud desktop platform.')
  @section('meta-keywords', 'privacy policy, data protection, personal information, pocket office privacy')
  @section('meta-image', 'https://pocketdesk.sizaf.com/assets/img/hero-images/Privacy-Policy.svg')
  @section('canonical', 'https://pocketdesk.sizaf.com/privacy')
  @section('meta-url', 'https://pocketdesk.sizaf.com/privacy')
  @section('structured-data')
  @verbatim
  {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "name": "Privacy Policy | Pocket Office",
    "url": "https://pocketdesk.sizaf.com/privacy",
    "description": "Review the Pocket Office privacy policy for data protection, personal information handling, and privacy rights in our cloud desktop platform.",
    "inLanguage": "en",
    "image": "https://pocketdesk.sizaf.com/assets/img/hero-images/Privacy-Policy.svg",
    "publisher": {
      "@type": "Organization",
      "name": "Pocket Office",
  ...
  <div class="terms-container">
    ...
    <div class="sidebar-section">
      <aside class="sidebar">
        ...
        <a href="#scope">
          <i class="fa fa-file-text mr-2"></i> Scope of This Policy
        </a>
        <a href="#information-collect">
          <i class="fa fa-database mr-2"></i> Information We Collect
        </a>
        <a href="#information-use">
          <i class="fa fa-cogs mr-2"></i> How We Use Information
        </a>
        <a href="#data-ownership">
          <i class="fa fa-key mr-2"></i> Data Ownership & Control
        </a>
        <a href="#data-security">
          <i class="fa fa-shield mr-2"></i> Data Security
        </a>
        <a href="#data-sharing">
          <i class="fa fa-share-alt mr-2"></i> Data Sharing & Disclosure
        </a>
        ...
        <a href="#childrens-privacy">
          <i class="fa fa-child mr-2"></i> Children’s Privacy
        </a>
        <a href="#changes">
          <i class="fa fa-refresh mr-2"></i> Changes to This Policy
        </a>
        <a href="#contact">
    ...
    <div class="content-section">
      ...
      <section id="scope" class="card">
        ...
        <div class="card-body">
          ...
          <ul>
            ...
            <li>Software applications and dashboards</li>
      ...
      <section id="information-collect" class="card">
        <div class="card-header">
          <div class="icon-box">
      ...
      <section id="information-use" class="card">
        <div class="card-header">
          <div class="icon-box">
      ...
      <section id="data-ownership" class="card">
        <div class="card-header">
          <div class="icon-box">
            <i class="fa fa-key"></i>
          </div>
      ...
      <section id="data-security" class="card">
        <div class="card-header">
          <div class="icon-box">
      ...
      <!--Data Sharing & Disclosure Section-->
      <section id="data-sharing" class="card">
        <div class="card-header">
          <div class="icon-box">
      ...
      <section id="data-retention" class="card">
        <div class="card-header">
          <div class="icon-box">
      ...
      <!--Cookies & Similar Technologies Seection-->
      ...
      <!-- International Access Section-->
      <section id="international-access" class="card">
        <div class="card-header">
          <div class="icon-box">
      ...
      <section id="childrens-privacy" class="card">
        <div class="card-header">
          <div class="icon-box">
