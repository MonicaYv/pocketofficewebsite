...
@section('meta-description', 'Experience Pocket Office, the secure browser-based cloud desktop workspace that lets your
    team access files, apps, and collaboration tools from anywhere without installation.')
@section('meta-keywords', 'cloud desktop, browser-based workspace, secure cloud desktop, remote collaboration, file
...
@section('structured-data')
    @verbatim
        ...
        "description": "Pocket Office is an AI-enabled browser-based cloud desktop workspace that gives teams secure access to
        files, apps, collaboration tools, and productivity software from anywhere.",
        "inLanguage": "en",
...
@section('preload')
    ...
    <link rel="preload" href="{{ asset('assets/img/hero_section_mob.webp') }}" as="image" type="image/webp"
...
@section('content')
    ...
    <section class="hero-header">
        ...
        assets/img/Hero-Section.webp 2500w"
                sizes="(max-width: 768px) 100vw, 1200px" alt="Pocket Office cloud desktop workspace interface"
                width="2500" height="1117" loading="eager" decoding="async" fetchpriority="high" />
        </div>
        <div class="">
        ...
        <div class="how-wrapper">
            ...
            <div class="how-cards">
                ...
                <div class="how-card">
                    <div class="how-card-img">
                        <video muted loop playsinline preload="none" class="lazy-video">
                            <source data-src="/assets/img/animated-videos/index/secure-by-design-video.mp4"
                                type="video/mp4">
                        </video>
                    </div>
            ...
            <div class="core-feature-content">
                ...
                <div class="core-feature-right">
                    <div class="feature-image-wrapper">
                        <video muted loop playsinline preload="none" class="lazy-video">
                            <source data-src="/assets/img/animated-videos/index/index-core-features-video.mp4"
                                type="video/mp4">
                        </video>
                    </div>
                </div>
    ...
    <section class="sector-adaptive-section">
        <div class="sector-adaptive-wrapper">
            ...
            <div class="sector-tabs">
                ...
                <button class="sector-tab" data-target="healthcare" data-img="/assets/img/sectors/healthcare-records.webp"
                    data-number="02">
                    02. 🏥 Healthcare
                </button>
            ...
            <div class="storage-content-wrapper">
                ...
                <div class="storage-left">
                        ...
                        <div class="storage-body">
                            <div class="storage-body-content">
                                ...
                                <div class="storage-video-mobile">
                                    <video muted loop playsinline preload="none" class="lazy-video">
                                        <source
                                            data-src="/assets/img/animated-videos/index/works-with-your-cloud-storage.mp4"
                                            type="video/mp4">
                                    </video>
                                </div>
                            </div>
                    ...
                    <div class="storage-item"
                        data-video="/assets/img/animated-videos/index/enterprise-on-prem-support.mp4">
        ...
        <div class="partners-container">
            ...
            <div class="partners-header">
                ...
                <h3 class="partners-title">
                    <!-- Handshake Icon SVG -->
                    <svg class="partners-icon" fill="none" stroke="currentColor" stroke-width="2"
            ...
            <div class="partners-marquee-container">
                <div class="partners-marquee-track">
                    <div class="partners-logo-strip">
                        ...
                        <img src="/assets/img/microsoft-logo.webp" alt="Microsoft" width="120" height="40"
                            loading="lazy" />
                        <img src="/assets/img/amazon-logo.webp" alt="Amazon" width="120" height="40"
                            loading="lazy" />
                        <img src="/assets/img/dell-logo.webp" alt="Dell" width="120" height="40"
                            loading="lazy" />
                        <img src="/assets/img/hp-logo.webp" alt="HP" width="120" height="40"
                            loading="lazy" />
                        <img src="/assets/img/cisco-logo.webp" alt="Cisco" width="120" height="40"
                            loading="lazy" />
                        <img src="/assets/img/fortinet-logo.webp" alt="Fortinet" width="120" height="40"
                            loading="lazy" />
                        <img src="/assets/img/kaspersky-logo.webp" alt="Kaspersky" width="120" height="40"
                            loading="lazy" />
                        <img src="/assets/img/sophos-logo.webp" alt="Sophos" width="120" height="40"
                            loading="lazy" />
                        <img src="/assets/img/veeam-logo.webp" alt="Veeam" width="120" height="40"
                            loading="lazy" />
                        <img src="/assets/img/alibaba-cloud-logo.webp" alt="Alibaba Cloud" width="120" height="40"
                            loading="lazy" />
                    </div>
                    <div class="partners-logo-strip" aria-hidden="true">
                        <img src="/assets/img/microsoft-logo.webp" alt="Microsoft" width="120" height="40"
                            loading="lazy" />
                        <img src="/assets/img/amazon-logo.webp" alt="Amazon" width="120" height="40"
                            loading="lazy" />
