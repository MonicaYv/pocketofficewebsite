    ...
    @section('meta-image', 'https://pocket-office.ai/assets/img/hero-images/news.svg')
    @section('canonical', 'https://pocket-office.ai/news')
    @section('meta-url', 'https://pocket-office.ai/news')
    ...
    @verbatim
    {
      ...
      "url": "https://pocket-office.ai/news",
      ...
      "inLanguage": "en",
      "image": "https://pocket-office.ai/assets/img/hero-images/news.svg",
      "publisher": {
        "@type": "Organization",
        "name": "Pocket Office",
