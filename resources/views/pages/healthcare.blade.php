 ...
 <div class="breadcrumb-area"
     style="background-image: url(assets/img/hero-images/industries/Healthcare/Healthcare\ 1.svg)">
     <div class="container">
         <div class="row">
             <div class="col-lg-12">
...
">
     ...
     <main class="main">
         ...
         <div class="banner">
             <img src="{{ asset($constants['IMAGEFILEPATH'] . 'hero-images/industries/Healthcare/Healthcare 2.svg') }}" alt="Healthcare" />
             <div class="overlay">
         ...
         <div class="section">
             <h2>An overview</h2>
             <p>
                 PocketOffice enables healthcare teams to access files and systems with controlled permissions,
                 maintaining privacy and regulatory compliance while supporting remote and hybrid work.
             </p>
         </div>
         ...
         <div class="section">
             ...
             <p>
                 PocketOffice provides Secure Data Access & Compliance
                 Access critical information securely..
             </p>
             <div class="features">
                 <div class="feature">
                     <h4>Centralized Healthcare Files</h4>
                     <h6>Information where care happens.</h6>
                     <p>Healthcare teams can securely access documents across hospitals, clinics, and remote
                         locations without relying on local systems.
                     </p>
                 </div>
                 <div class="feature">
                     <h4>Remote-Ready Workflows</h4>
                     <h6>Support modern healthcare delivery.</h6>
                     <p>Enable distributed teams and telehealth workflows while keeping sensitive data protected.</p>
                 </div>
                 <div class="feature">
                     <h4>Privacy-First Access Control</h4>
                     <h6>Protect sensitive information.</h6>
                     <p>Strict role-based permissions ensure only authorized personnel can view or manage
                         confidential healthcare data.</p>
                 </div>
                 <div class="feature">
                     <h4>Industry Software Integration</h4>
                     <h6>Supports healthcare management systems.</h6>
                     <p>Integrates with EHR systems, hospital management software, and secure cloud platforms for
                         managing reports and medical documentation.</p>
                 </div>
             </div>
         </div>
         <div class="services">
         ...
         <div class="services-heading">
             <h1>Benefits</h1>
             <p>
                 Provides comprehensive healthcare solutions that improve patient outcomes, enhance operational
                 efficiency, and ensure secure, compliant management of medical data while delivering high-quality,
                 accessible care.
             </p>
         </div>
