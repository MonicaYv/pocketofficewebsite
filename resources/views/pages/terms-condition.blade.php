 ...
 <div class="terms-container">
   ...
   <div class="sidebar-section">
     <aside class="sidebar">
       ...
       <a href="#account-responsibilities">
         <i class="fa fa-user mr-2"></i> Account Responsibilities
       </a>
       ...
       <a href="#security-responsibility">
         <i class="fa fa-lock mr-2"></i> Security Responsibilities
       </a>

       <a href="#service-availaibility">
         <i class="fa fa-cogs mr-2"></i> Service Availability & Changes
       </a>

       <a href="#third-party-services">
         <i class="fa fa-external-link mr-2"></i> Third-Party Services
       </a>
       ...
       <a href="#suspension">
         <i class="fa fa-ban mr-2"></i> Suspension & Termination
       </a>
       ...
       <a href="#compliance">
         <i class="fa fa-shield mr-2"></i> Compliance with Policies
       </a>

       <a href="#changes-to-terms">
         <i class="fa fa-refresh mr-2"></i> Changes to These Terms
       </a>
   ...
   <div class="content-section">
     ...
     <!--Service Availaibility & Changes Section-->
     <section id="service-availaibility" class="card">
       <div class="card-header">
         <div class="icon-box">
     ...
     <section id="suspension" class="card">
       <div class="card-header">
         <div class="icon-box">
           <i class="fa fa-ban"></i>
         </div>
     ...
     <section id="changes-to-terms" class="card">
       <div class="card-header">
         <div class="icon-box">
