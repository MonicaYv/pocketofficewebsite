   ...
   @section('meta-image', 'https://pocket-office.ai/assets/img/hero-images/disclaimer .svg')
   @section('canonical', 'https://pocket-office.ai/disclaimer')
   @section('meta-url', 'https://pocket-office.ai/disclaimer')
   ...
   @verbatim
   {
     ...
     "url": "https://pocket-office.ai/disclaimer",
     ...
     "inLanguage": "en",
     "image": "https://pocket-office.ai/assets/img/hero-images/disclaimer .svg",
     "publisher": {
       "@type": "Organization",
       "name": "Pocket Office",
