 ...
 <div class="breadcrumb-area"
     style="background-image: url(assets/img/hero-images/industries/Finance-Accounting/Finance\ &\ Accounting\ 1.svg)">
     <div class="container">
         <div class="row">
             <div class="col-lg-12">
...
">
     ...
     <main class="main">
         ...
         <div class="banner">
             <img src="{{ asset($constants['IMAGEFILEPATH'] . 'hero-images/industries/Finance-Accounting/Finance & Accounting 2.svg') }}"
         ...
         <div class="section">
             <h2>An overview</h2>
             <p>
                 PocketOffice enables finance teams to manage reports, invoices, and records within secure
                 workspaces, with strict access controls and comprehensive activity tracking
             </p>
         </div>
         ...
         <div class="section">
             ...
             <p>
                 PocketOffice provides Secure Financial Document Handling
             ...
             <div class="features">
                 <div class="feature">
                     ...
                     <p>Reports, invoices, and records are stored in a structured cloud workspace that simplifies
                 ...
                 <div class="feature">
                     ...
                     <p>Permissions ensure financial information is only accessible to authorized users, reducing
                         risk and exposure.
                     </p>
                 </div>
                 <div class="feature">
                     ...
                     <p>Instant updates prevent errors caused by outdated spreadsheets or duplicated files.</p>
                 </div>
                 <div class="feature">
                     <h4>Industry Software Integration</h4>
                     <h6>Connect with financial management tools.</h6>
                     <p>Works with platforms like QuickBooks, Zoho Books, Xero, and SAP Financials to streamline
                         financial reporting and document management.</p>
                 </div>
             </div>
         </div>
         <div class="services">
         ...
         <div class="services-heading">
             <h1>Benefits</h1>
             <p>
                 Provides reliable financing and accounting solutions that strengthen financial stability, ensure
                 regulatory compliance, and deliver accurate insights to support smarter business decisions and
                 sustainable growth.
             </p>
         </div>
