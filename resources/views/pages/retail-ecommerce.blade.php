 ...
 @section('title', 'Retail Ecommerce')
 @section('content')
 ...
 <div class="breadcrumb-area"
   style="background-image: url(assets/img/hero-images/industries/Retail-E-commerce/Retail\ &\ E-commerce\ 1.svg)">
   <div class="container">
     <div class="row">
       <div class="col-lg-12">
...
">
   ...
   <main class="main">
     ...
     <div class="banner">
       <img src="{{ asset($constants['IMAGEFILEPATH'] . 'hero-images/industries/Retail-E-commerce/Retail & E-commerce 2.svg') }}"
     ...
     <div class="section">
       <h2>An overview</h2>
       <p>
         Pocketoffice lets retail teams share inventory data, marketing assets, and operational documents from a
     ...
     <div class="section">
       ...
       <p>
         PocketOffice provides Team & Inventory Collaboration
         Coordinate teams seamlessly across locations.
       </p>
       <div class="features">
         <div class="feature">
           <h4>Central Operations Workspace</h4>
           <h6>Get one clear view of your operations. </h6>
           <p>Inventory data, marketing assets, and reports are accessible from a unified cloud desktop.</p>
         </div>
         <div class="feature">
           <h4>Real-Time Updates</h4>
           <h6>Keep teams aligned. </h6>
           <p>Stock levels and promotions update instantly so everyone stays informed.</p>
         </div>
         <div class="feature">
           <h4> Multi-Location Support</h4>
           <h6>Connect teams everywhere. </h6>
           <p>Stores, warehouses, and headquarters work seamlessly from the same system.</p>
         </div>
         <div class="feature">
           <h4>Industry Software Integration</h4>
           <h6>Supports modern retail platforms.</h6>
           <p>Works with platforms such as Shopify, WooCommerce, and Magento to manage product information, reports,
             and business documentation.</p>
         </div>
       </div>
     </div>
     <div class="services">
     ...
     <div class="services-heading">
       <h1>Benefits</h1>
       <p>
         Provides innovative retail and e-commerce solutions that enhance customer experiences, optimize inventory and
         supply chain operations, and drive sales growth through seamless, secure, and data-driven digital commerce
         platforms.
       </p>
     </div>
