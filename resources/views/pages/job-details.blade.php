    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-6 col-lg-8 offset-xl-1">
          ...
          <h6 class="title">Fashion Designer</h6>
          ...
          <ul>
            <li>
              Find out fashion trends of International market and to work out
              of them
            </li>
            <li>
              Creation of creative fashion design that suits the company
              brand's requirement.
            </li>
            <li>
            ...
            <li>
              Able to work in illustrator or any other fashion design software
              to develop Woven tops & Bottom sketches for men, ladies, kids
              accessories details.
            </li>
            ...
            <li>
              ...
              based on seasons that will generate sales in local and global
              market
            </li>
            <li>
              Study & analyze the market & industry trend to have a reflection
              on product design & development to fulfill the customer needs
            </li>
            <li>
              Present innovative saleable design ideas to the creative
              director, MD and sales team Determine product fabric & fitting
              (select fabrics, embellishments, color, styles which will fit
              for each garmentor accessory within the budget)
            </li>
            <li>
              Understanding design from technical perspective, developing
              pattern & supervision of these including fitting, detailing &
              adaptions
            </li>
