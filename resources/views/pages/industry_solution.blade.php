<a href="{{ url('business-process-outsourcing') }}"> <i class="fa fa-phone mr-2"></i>BPO Outsourcing </a>

<a href="{{ url('ai-business-consulting') }}">
    <i class="fa fa-briefcase mr-2"></i>Consulting
</a>

<a href="{{ url('web-design-services') }}">
    <i class="fa fa-paint-brush mr-2"></i>Design & Media Studios
</a>

<a href="{{ url('ai-in-education') }}">
    <i class="fa fa-graduation-cap mr-2"></i>Education
</a>

<a href="{{ url('accounting-software') }}">
    <i class="fa fa-line-chart mr-2"></i>Finance & Accounting
</a>

<a href="{{ url('ai-in-healthcare') }}">
    <i class="fa fa-heartbeat mr-2"></i>Healthcare
</a>

<a href="{{ url('it-software-solutions') }}">
    <i class="fa fa-desktop mr-2"></i>IT & Software Development
</a>

<a href="{{ url('legal-case-management-software') }}">
    <i class="fa fa-balance-scale mr-2"></i>Legal Services
</a>

<a href="{{ url('manufacturing-management-software') }}">
